    ...
    <div className="background-color">
      ...
      <Container fluid className="startFullHeight">
        <Row className="small-height align-items-center justify-content-center text-center fadeIn shifted-down">
          <Col lg="6">
            <p className="container-text text-monospace little-box">
              Record box is a digitized vinyl library to organize all the
              records in your collection
            </p>
            <a href="https://record-box.herokuapp.com/" className="link-color">
              Click here to check it out!
            </a>
          </Col>
          <Col lg="6" className="little-box">
        ...
        <Row className="small-height align-items-center justify-content-center text-center border-up fadeIn4 shifted-down">
          ...
          <Col lg="6" className="little-box">
            <p className="container-text text-monospace">
              You want a cat but you don't know where to start from? The cat app
              is perfect for you!
            </p>
            <a href="https://the-cat-app.herokuapp.com/" className="link-color">
              Click here to check it out!
            </a>
          </Col>
        </Row>
        ...
        <Row className="small-height align-items-center justify-content-center text-center border-up fadeIn5 shifted-down ">
          <Col lg="6">
            <p className="container-text text-monospace">
              Run, run, Run and jump between obstacles. If you touch the lava,
              you're dead!
            </p>
            <a
              href="https://happy-galileo-040424.netlify.app/"
